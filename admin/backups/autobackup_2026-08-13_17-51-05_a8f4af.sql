...
INSERT INTO `customer_wallets` VALUES ('13', '11', '0.00', '2026-08-12 11:24:46', '0');
INSERT INTO `customer_wallets` VALUES ('16', '7', '180460.60', '2026-08-13 11:06:25', '1');
...
INSERT INTO `customer_wallets` VALUES ('19', '15', '503750.00', '2026-08-12 11:22:29', '1');
...
INSERT INTO `order_items` VALUES ('186', '102', '58', '1', '145454.55', '14545.45', '160000.00');
INSERT INTO `order_items` VALUES ('187', '103', '58', '1', '145454.55', '14545.45', '160000.00');
...
INSERT INTO `orders` VALUES ('102', '7', 'A051534789G', '145454.55', '14545.45', '10.00', '160000.00', 'delivered', '2026-08-12 23:51:46', 'Sarah Andrew');
INSERT INTO `orders` VALUES ('103', '7', 'A051534789G', '145454.55', '14545.45', '10.00', '160000.00', 'pending', '2026-08-13 11:06:25', 'System Automated Checkout');
...
INSERT INTO `payments` VALUES ('103', NULL, 'M-Pesa Deposit', 'TXN_DEP_U7_99B4B296', '500000.00', 'completed', '2026-08-12 23:50:56');
INSERT INTO `payments` VALUES ('104', '102', 'Customer Wallet', 'TXN_6A7CDCE220F5D', '160000.00', 'completed', '2026-08-12 23:51:46');
INSERT INTO `payments` VALUES ('105', '103', 'Customer Wallet', 'TXN_6A7D7B0144BD0', '160000.00', 'completed', '2026-08-13 11:06:25');
...
INSERT INTO `polepole_reminders` VALUES ('1', '6', '12', '33', '2026-08-13', '13:00', 'in_app', 'Hello john allan, a friendly ADONAK ELECTRONICS reminder: order #33 has a Lipa Pole Pole balance of KES 168.00, due by 23 Aug 2026. You may pay any amount toward it before the deadline. Thank you.', '2026-08-13 13:22:47');
INSERT INTO `polepole_reminders` VALUES ('2', '7', '12', '38', '2026-08-13', '13:00', 'in_app', 'Hello john allan, a friendly ADONAK ELECTRONICS reminder: order #38 has a Lipa Pole Pole balance of KES 1.00, due by 23 Aug 2026. You may pay any amount toward it before the deadline. Thank you.', '2026-08-13 13:22:47');
INSERT INTO `polepole_reminders` VALUES ('3', '8', '12', '39', '2026-08-13', '13:00', 'in_app', 'Hello john allan, a friendly ADONAK ELECTRONICS reminder: order #39 has a Lipa Pole Pole balance of KES 68.00, due by 23 Aug 2026. You may pay any amount toward it before the deadline. Thank you.', '2026-08-13 13:22:47');
...
CREATE TABLE `product_reviews` (
  ...
  `moderation_status` enum('pending','live','hidden','rejected') NOT NULL DEFAULT 'pending',
...
INSERT INTO `product_reviews` VALUES ('3', '7', '54', 'james kimani', '4', 'good product', '1', 'live', NULL, NULL, NULL, '2026-07-27 10:33:49');
INSERT INTO `product_reviews` VALUES ('4', '7', '53', 'james kimani', '5', 'good', '1', 'live', NULL, NULL, NULL, '2026-07-27 10:41:03');
INSERT INTO `product_reviews` VALUES ('5', '7', '52', 'james kimani', '4', 'great experience', '1', 'live', NULL, NULL, NULL, '2026-07-27 10:56:10');
INSERT INTO `product_reviews` VALUES ('8', '10', '52', 'peter otieno', '5', 'goood', '1', 'live', NULL, NULL, NULL, '2026-07-28 00:25:34');
INSERT INTO `product_reviews` VALUES ('10', '10', '54', 'peter otieno', '5', 'wow', '1', 'live', NULL, NULL, NULL, '2026-07-28 01:35:36');
INSERT INTO `product_reviews` VALUES ('11', '12', '52', 'john allan', '5', 'very good product', '1', 'live', NULL, NULL, NULL, '2026-08-02 02:10:12');
INSERT INTO `product_reviews` VALUES ('12', '7', '57', 'james kimani', '5', 'great', '1', 'live', NULL, NULL, NULL, '2026-08-10 22:47:34');
INSERT INTO `product_reviews` VALUES ('14', '7', '55', 'james kimani', '5', 'high quality covers from adonak', '1', 'live', '6', '2026-08-12 22:43:39', NULL, '2026-08-10 23:09:17');
INSERT INTO `product_reviews` VALUES ('15', '7', '58', 'james kimani', '5', 'it is an amazng smart phone with quality camera', '1', 'live', '6', '2026-08-13 00:25:02', NULL, '2026-08-12 23:56:07');
...
INSERT INTO `products` VALUES ('58', '20', '22', 'VIVO@GMAIL.COM', 'VIVO X200', 'X200', '160000.00', '18', '1786444629_vivo X200 Pro 5G 6_78_ 200MP 256_ 512GB 1TB Dimensity 9400 Android 15 CN version Opens in a new wind.jpg', 'BEST QUALITY SMART PHONE FROM VIVO INDUSTRIES,\r\nONE YEAR WARRANT.\r\nBEST CAMERA', '2026-08-11 13:37:09');

DROP TABLE IF EXISTS `purchase_reorders`;
CREATE TABLE `purchase_reorders` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `product_id` int(11) NOT NULL,
  ...
  `status` enum('sent','confirmed','received','cancelled') NOT NULL DEFAULT 'sent',
...
INSERT INTO `purchase_reorders` VALUES ('1', '54', 'SAMSUNG@GMAIL.COM', '', '', '4', '4', '0.00', '7', 'cancelled', '5', '2026-08-11 23:01:47', '2026-08-11 23:03:57');
...
INSERT INTO `staff_attendance` VALUES ('16', '6', 'Sarah Andrew', '2026-08-12 14:47:49', '2026-08-12 14:47:56', '::1', 'Completed', 'short_coverage');
...
CREATE TABLE `staff_logs` (
  ...
  `user_id` int(11) NOT NULL,
  `staff_name` varchar(100) NOT NULL,
  `action_type` varchar(80) NOT NULL DEFAULT 'System Activity',
...
INSERT INTO `staff_logs` VALUES ('290', '5', 'Maxies John', '', NULL, 'Manual database backup created: autobackup_2026-08-11_21-32-23_57899b.sql.', '2026-08-11 21:32:23');
INSERT INTO `staff_logs` VALUES ('291', '5', 'Maxies John', 'Financial Update', NULL, 'Tax receipt generated for fully paid order #98.', '2026-08-11 22:21:33');
INSERT INTO `staff_logs` VALUES ('292', '5', 'Maxies John', 'Financial Update', NULL, 'Tax receipt generated for fully paid order #98.', '2026-08-11 22:26:17');
INSERT INTO `staff_logs` VALUES ('293', '5', 'Maxies John', 'Financial Update', NULL, 'Tax receipt generated for fully paid order #98.', '2026-08-11 22:32:16');
INSERT INTO `staff_logs` VALUES ('294', '5', 'Maxies John', 'Inventory Update', NULL, 'Supplier reorder email sent for SUMSANG S26 ULTRA (4 units), request #1.', '2026-08-11 23:01:47');
INSERT INTO `staff_logs` VALUES ('295', '5', 'Maxies John', 'Inventory Update', NULL, 'Reorder #1 marked confirmed.', '2026-08-11 23:03:08');
INSERT INTO `staff_logs` VALUES ('296', '5', 'Maxies John', 'Inventory Update', NULL, 'Reorder #1 marked cancelled.', '2026-08-11 23:03:57');
INSERT INTO `staff_logs` VALUES ('297', '5', 'Maxies John', 'Staff Login', NULL, 'Secure admin entry validated via IP: ::1', '2026-08-12 00:42:58');
INSERT INTO `staff_logs` VALUES ('298', '5', 'Maxies John', 'Staff Login', NULL, 'Secure admin entry validated via IP: ::1', '2026-08-12 10:41:03');
INSERT INTO `staff_logs` VALUES ('299', '5', 'Maxies John', 'Financial Update', NULL, 'Wallet #19: KES 502,750.00 to KES 503,750.00', '2026-08-12 11:22:29');
INSERT INTO `staff_logs` VALUES ('300', '5', 'Maxies John', 'Financial Update', NULL, 'Wallet #13: KES 94.00 to KES 0.00', '2026-08-12 11:24:46');
INSERT INTO `staff_logs` VALUES ('301', '5', 'Maxies John', 'Staff Login', NULL, 'Secure admin entry validated via IP: ::1', '2026-08-12 12:39:45');
INSERT INTO `staff_logs` VALUES ('302', '5', 'Maxies John', 'Financial Update', NULL, 'Tax receipt generated for fully paid order #17.', '2026-08-12 12:49:40');
INSERT INTO `staff_logs` VALUES ('303', '6', 'Sarah Andrew', 'Staff Login', NULL, 'Secure staff desk entry validated via IP: ::1', '2026-08-12 13:55:07');
INSERT INTO `staff_logs` VALUES ('304', '6', 'Sarah Andrew', 'Staff Login', NULL, 'Secure staff desk entry validated via IP: ::1', '2026-08-12 14:47:29');
INSERT INTO `staff_logs` VALUES ('305', '6', 'Sarah Andrew', 'System Update', NULL, 'Review moderation: review #14 changed to hidden.', '2026-08-12 14:53:52');
INSERT INTO `staff_logs` VALUES ('306', '6', 'Sarah Andrew', 'Staff Login', NULL, 'Secure staff desk entry validated via IP: ::1', '2026-08-12 21:28:39');
INSERT INTO `staff_logs` VALUES ('307', '6', 'Sarah Andrew', 'Staff Login', NULL, 'Secure staff desk entry validated via IP: ::1', '2026-08-12 22:13:26');
INSERT INTO `staff_logs` VALUES ('308', '6', 'Sarah Andrew', 'System Update', NULL, 'Review moderation: review #14 changed to rejected.', '2026-08-12 22:38:24');
INSERT INTO `staff_logs` VALUES ('309', '6', 'Sarah Andrew', 'System Update', NULL, 'Review moderation: review #14 changed to live.', '2026-08-12 22:43:39');
INSERT INTO `staff_logs` VALUES ('310', '10', 'peter otieno', 'Staff Login', NULL, 'Secure staff desk entry validated via IP: 127.0.0.1', '2026-08-12 23:25:56');
INSERT INTO `staff_logs` VALUES ('311', '5', 'Maxies John', 'Staff Login', NULL, 'Secure admin entry validated via IP: 127.0.0.1', '2026-08-12 23:36:36');
INSERT INTO `staff_logs` VALUES ('312', '6', 'Sarah Andrew', 'System Update', NULL, 'Review moderation: review #15 changed to live.', '2026-08-13 00:25:02');
INSERT INTO `staff_logs` VALUES ('313', '5', 'Maxies John', 'Staff Login', NULL, 'Super Administrator login completed with email OTP via IP: ::1', '2026-08-13 00:51:35');
INSERT INTO `staff_logs` VALUES ('314', '6', 'Sarah Andrew', 'Staff Login', NULL, 'Secure staff entry validated via IP: ::1', '2026-08-13 09:26:37');
INSERT INTO `staff_logs` VALUES ('315', '5', 'Maxies John', 'Staff Login', NULL, 'Super Administrator login completed with email OTP via IP: ::1', '2026-08-13 11:27:46');
INSERT INTO `staff_logs` VALUES ('316', '5', 'Maxies John', 'Financial Update', NULL, 'Tax receipt generated for fully paid order #78.', '2026-08-13 11:51:54');
INSERT INTO `staff_logs` VALUES ('317', '5', 'Maxies John', 'Financial Update', NULL, 'Tax receipt generated for fully paid order #98.', '2026-08-13 11:53:41');
INSERT INTO `staff_logs` VALUES ('318', '5', 'Maxies John', 'Financial Update', NULL, 'Tax receipt generated for fully paid order #98.', '2026-08-13 11:54:47');
INSERT INTO `staff_logs` VALUES ('319', '5', 'Maxies John', 'Financial Update', NULL, 'Tax receipt generated for fully paid order #88.', '2026-08-13 11:59:04');
INSERT INTO `staff_logs` VALUES ('320', '5', 'Maxies John', 'Financial Update', NULL, 'Tax receipt generated for fully paid order #17.', '2026-08-13 12:16:03');
INSERT INTO `staff_logs` VALUES ('321', '5', 'Maxies John', 'Financial Update', NULL, 'Tax receipt generated for fully paid order #101.', '2026-08-13 12:21:37');
INSERT INTO `staff_logs` VALUES ('322', '5', 'Maxies John', 'Staff Login', NULL, 'Super Administrator login completed with email OTP via IP: ::1', '2026-08-13 17:37:20');
...
INSERT INTO `users` VALUES ('7', 'james kimani', 'james@gmail.com', '797898989', '$2y$10$yEOF6V67dBTT7yHZNFGDo.xH1zpYLQBTdxgjm8qPZJWSsx5OEB7qu', '3', '2026-07-08 19:03:43', '797898989', 'JERU, ACTION VILLA PLAZA, 1ST FLOOR, HOUSE NUMBER 103', 'A051534789G', NULL, NULL, 'active');
